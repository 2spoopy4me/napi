...
def network_traffic(format: str, interface: str):
    ...
    state = {
                'bytes_sent':current_state['en0'][0],
                'bytes_recv':current_state['en0'][1],
                'packets_sent':current_state['en0'][2],
                'packets_recv':current_state['en0'][3],
                'errin':current_state['en0'][4],
                'errout':current_state['en0'][5],
